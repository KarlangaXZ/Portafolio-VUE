...
export const games = [
  ...
  { slug: 'apex-legends', title: 'Apex Legends', genre: 'Battle Royale / FPS', studio: 'Respawn Entertainment', label: 'Competitive', initials: 'APEX' },
  { slug: 'forza-horizon', title: 'Forza Horizon', genre: 'Open World Racing', studio: 'Playground Games en colaboración con Turn 10 Studios', label: 'Racing / Casual', initials: 'FH' },
